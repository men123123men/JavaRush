...
public static interface Alive {
    Object containsBones();          //  boolean containsBones();
}
public static class BodyPart implements Alive {
    ...
    public Object containsBones() { // public boolean containsBones() { return true; }
        return "Yes";
    }
    public String toString() {
        return containsBones().equals("Yes")?name+" содержит кости":name+" не содержит кости";
      //return containsBones() ? name + ...
    }
}
public static class Finger extends BodyPart {
    ...
    @Override
    public Object containsBones() {  // public boolean containsBones() {
