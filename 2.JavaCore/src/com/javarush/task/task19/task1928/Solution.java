...
public class Solution {
    ...
    public static void main(String... args) throws IOException {
        try ( FileOutputStream outputStream = new FileOutputStream(args[0]);
            ...
            String s = "a";
            switch (s) {
                case "a": result = new Solution().new A(); break;

                case "b": result = new Solution().new B(); break;

                case "c": result = new Solution().new C(); break;

            }

            //C p = (C) result;
            
            if (result instanceof C) { //IntelliJ IDEA
//
