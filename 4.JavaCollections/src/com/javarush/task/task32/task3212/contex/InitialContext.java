...
public class InitialContext {
    public Object lookup(String jndiName) {
        Service result = null;
        switch(jndiName){
            case "EJBService": System.out.println("Looking up and creating a new EJBService object");
                result = new EJBServiceImpl(); break;
            case "JMSService": System.out.println("Looking up and creating a new JMSService object");
                result = new JMSServiceImpl(); break;
        }
        return result;
